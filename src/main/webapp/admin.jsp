    ...
    <form method="post" action="admin" class="mt-5 w-50">
        ...
        <div class="row">
            <div class="col">
                ...
                <div class="row">
                    <div class="form-outline mb-4">
                        <input type="number" id="edition" class="form-control" value="1" min="1" name="edition"
                               required/>
                ...
                <div class="mb-4">
                    ...
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="categories"
                               value="<%= category.getId() %>" id="<%= category.getId() %>">
                        <label class="form-check-label" for="<%= category.getId() %>"><%= category.getName() %>
                        </label>
                    </div>
                    <%
                        }
